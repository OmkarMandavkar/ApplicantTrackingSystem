...
<html lang="en">
  <head>
    ...
    <title>Send Joining Letter</title>
    ...
    <div class="wrapper">
        ...
        <div class="main-content">
            <div class="container mt-2">
                <form action="${pageContext.request.contextPath}/recruiter/sendJoiningLetter" method="post">    
                
                <input type="hidden" name="applicationId" value="${emailData.jobMaster.applicationId}">
                ...
                <div class="card p-2">
                    ...
                    <div class="p-3 mb-3">
                        <div class="card-body-grid">
                            <div class="mb-4">
								<input type="hidden" class="form-control" name="roundId" value="${emailData.jobMaster.applicationId}">
                            </div>            
                            <div class="row">
		                    ...
		                    <div class="row">
	                            <div class="col-md-6 mb-4">
									...
									<input type="text" class="form-control" name="company" value="${emailData.jobMaster.jobDescription.company.companyName}" readonly>
	                            </div>            
	                            <div class="col-md-6 mb-4">
	                                <p class="font-weight-bold mb-1">Job Title</p>
									<input type="text" class="form-control" name="title" value="${emailData.jobMaster.jobDescription.title}" readonly>
	                            </div>
		                    </div>
		                    <div class="row">
		                        <div class="col-md-6 mb-4">
								    <label for="joiningDate" class="font-weight-bold">Joining Date</label>
								    <input type="date" class="form-control" id="joiningDate" name="joiningDate" required>
		                        </div>
		                    </div>
                        </div>
                    </div>
			        <button type="submit" class="btn btn-primary btn-block mb-2" style="width: 30%; margin: 0px auto">Send Offer Letter</button>
                </div>
				</form>
            </div>
        </div>
