...
public class JobRoundService {
	...
	public JobRoundService(JobMasterRepository jobMasterRepository, JobRoundRepository jobRoundRepository,
			RecruiterRepository recruiterRepository, JavaMailSender mailSender) {
