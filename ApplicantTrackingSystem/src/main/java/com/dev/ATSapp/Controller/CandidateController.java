...
public class CandidateController {
	...
	public CandidateController(AuthService authService, CandidateService candidateService,
			...
			JobMasterService jobMasterService, SuperAdminService superAdminService, SavedJobsService savedJobsService,
			JobRoundService jobRoundService, RoundDetailsService roundDetailsService) {
