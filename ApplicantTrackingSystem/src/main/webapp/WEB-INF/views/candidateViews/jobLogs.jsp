                ...
                <table class="table table-bordered table-hover" id="jobTable">
                  <thead class="thead text-center">
                    <tr>
                      ...
                      <th style="width: 12%">Job Location</th>
                      <th style="width: 8%">Round</th>
                      <th style="width: 10%">Round Status</th>
                    </tr>
                  </thead>
                  <tbody class="text-left">
                    <c:forEach var="data" items="${jobLogs}">
                      <tr>
                        <td style="text-align: left !important">${data.jobMaster.jobDescription.title}</td>
                        <td style="text-align: left !important">${data.jobMaster.company.companyName}</td>
                        <td style="text-align: left !important">${data.jobMaster.jobDescription.jobLocation}</td>
                        <td>${data.roundNumber}</td>
                        <td style="text-align: left !important">${data.roundStatus}</td>
                      </tr>
                    </c:forEach>
                  </tbody>
                </table>
