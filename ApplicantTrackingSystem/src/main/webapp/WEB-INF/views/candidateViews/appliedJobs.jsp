            ...
            <c:choose>
                <c:when test="${empty JobData}">
                    <div class="text-center mt-5">
                        ...
                        <h4 class="mt-3">No jobs found at the moment!</h4>
                        <p>Start exploring available jobs that match your skills.</p>
                        <a href="<%=request.getContextPath()%>/candidate/viewAllActiveJobs" class="btn btn-primary">
                        ...
                        <table class="table table-bordered table-hover" id="jobTable">
                            ...
                            <tbody>
                                <c:forEach var="data" items="${JobData}">
                                    <tr>
                                        <td class="text-left">${data.jobDescription.title}</td>
                                        <td class="text-left">${data.company.companyName}</td>
                                        <td class="text-left">${data.jobDescription.jobLocation}</td>
                                        <td>${data.jobDescription.experience}</td>
                                        <td>${data.appliedDate}</td>
                                        <td class="text-left">${data.candidateStatus}</td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
